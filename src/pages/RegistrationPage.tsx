...
import { Label } from "@/components/ui/label"; // Label is part of FormItem usually, or standalone
...
const RegistrationPage: React.FC = () => {
  ...
  const onSubmit = (data: RegistrationFormValues) => {
    ...
    alert("Registration successful! Please login."); // Replace with Sonner toast
    navigate('/login');
  };
